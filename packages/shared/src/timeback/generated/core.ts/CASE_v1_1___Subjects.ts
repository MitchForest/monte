...
export const endpoints = makeApi([
  {
    method: "get",
    path: "/ims/case/v1p1/CFSubjects/:sourcedId",
    alias: "getImsCaseV1p1CFSubjectsBySourcedId",
    description: `Retrieve a subject and all its child subjects based on hierarchy codes`,
    requestFormat: "json",
    parameters: [
      {
        name: "sourcedId",
...
export const CASE_v1_1___SubjectsApi = new Zodios(endpoints);

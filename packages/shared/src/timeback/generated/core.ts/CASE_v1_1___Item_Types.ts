...
export const endpoints = makeApi([
  {
    method: "get",
    path: "/ims/case/v1p1/CFItemTypes/:sourcedId",
    alias: "getImsCaseV1p1CFItemTypesBySourcedId",
    description: `Retrieve an item type and all its child types based on hierarchy codes`,
    requestFormat: "json",
    parameters: [
      {
        name: "sourcedId",
...
export const CASE_v1_1___Item_TypesApi = new Zodios(endpoints);

...
export const endpoints = makeApi([
  {
    method: "get",
    path: "/ims/case/v1p1/CFAssociationGroupings/:sourcedId",
    alias: "getImsCaseV1p1CFAssociationGroupingsBySourcedId",
    description: `Retrieve a specific association grouping definition`,
    requestFormat: "json",
    parameters: [
      {
        name: "sourcedId",
    ...
    errors: [
      ...
      {
        status: 404,
        description: `Association grouping not found`,
        schema: z
          .object({
            imsx_codeMajor: z.enum(["failure", "success"]),
            imsx_severity: z.enum(["error", "warning", "info"]),
...
export const CASE_v1_1___Association_GroupingsApi = new Zodios(endpoints);

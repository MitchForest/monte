...
export interface AppUserOrgRoles {
  org_id: string | null;
  role: Role | null;
  user_id: string | null;
}
...
export interface AuthSessions2 {
  created_at: Generated<Timestamp>;
...
export interface WorkPeriodItems {
...
export interface DB {
  ...
  "app.user_org_roles": AppUserOrgRoles;
  auth_accounts: AuthAccounts;
  auth_sessions: AuthSessions2;

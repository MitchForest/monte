...
type ViewModelOverrides = Omit<Partial<EditorViewModel>, 'selection' | 'resources' | 'actions'> & {
  selection?: Partial<EditorViewModel['selection']>;
  resources?: Partial<EditorViewModel['resources']>;
  actions?: Partial<EditorViewModel['actions']>;
};
...
const createViewModel = (
  ...
  const selectionDefaults: EditorViewModel['selection'] = {
  ...
  const resourcesDefaults: EditorViewModel['resources'] = {
    curriculumTree: () => undefined,
    setCurriculumTree: vi.fn(),
    updateCurriculumTree: vi.fn(),
    refetchTree: vi.fn().mockResolvedValue(undefined),
    lessonRecord: () => undefined,
    refetchLessonRecord: vi.fn().mockResolvedValue(undefined),
    refreshLessonAndTree: vi.fn().mockResolvedValue(undefined),
  };

  const actionsDefaults: EditorViewModel['actions'] = {

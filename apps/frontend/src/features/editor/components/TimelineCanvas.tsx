...
import { LessonCanvas } from '../../lesson-player/components/canvas';
import { useLessonCanvasContext } from '../../lesson-player/components/canvas/context';
import {
  GoldenBeadHundred,
  GoldenBeadTen,
  GoldenBeadThousand,
  ...
  GoldenBeadUnit,
  YellowRibbon,
} from '../../lesson-player/components/materials';
